...
public class XYLineChartBuilder {
  ...
  /**
   * Helper that just saves the chart as specified png-file. The width of the image is 1000 and
   * height 600.
   *
   * @param chart
   * @param pngFilename
   ...
   * @return the builder
   */
  public static XYLineChartBuilder newInstance(String chartTitle, String xDomainName,
      String yDomainName) {
