...
public class CircleExample {
  ...
  public static Collection<Coordinate> createCoordinates(double center_x, double center_y,
  ...
  public static void main(String[] args) {
    ...
    for (Coordinate c : circle) {
      Service s = Service.Builder.newInstance(Integer.toString(id))
          .setLocation(Location.Builder.newInstance().setCoordinate(c).build()).build();
      vrpBuilder.addJob(s);
      id++;
    }
