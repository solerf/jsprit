...
public class MultipleDepotWithInitialRoutesExample {
  ...
  public static void main(String[] args) {
    ...
    VehicleRoute initialRoute = VehicleRoute.Builder
        .newInstance(getVehicle("1_4_vehicle", vrpBuilder)).addService(getService("44", vrpBuilder))
    ...
    /*
     * since job (service) 26 and 44 are already planned in initial route and thus static AND
     * sequence is fixed they should not be in jobMap anymore (only variable jobs are in jobMap)
     */
    assert !vrp.getJobs()
        .containsKey("26") : "strange. service 26 should not be part of the problem";
    assert !vrp.getJobs()
        .containsKey("44") : "strange. service 44 should not be part of the problem";
    ...
    new Plotter(vrp, Solutions.bestOf(solutions)).setLabel(Label.ID)
        .plot("output/cordeau01_solution_withInitialRoute.png", "p01");
