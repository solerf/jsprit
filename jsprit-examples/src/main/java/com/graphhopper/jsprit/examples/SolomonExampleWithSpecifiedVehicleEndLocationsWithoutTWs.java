...
public class SolomonExampleWithSpecifiedVehicleEndLocationsWithoutTWs {
  ...
  public static void main(String[] args) {
     ...
     * builder.
     */
    new VrpXMLReader(vrpBuilder).read(
        "input/pickups_and_deliveries_solomon_c101_withoutTWs_and_specifiedVehicleEndLocations.xml");
    ...
    // vra.getAlgorithmListeners().addListener(new
    // AlgorithmSearchProgressChartListener("output/sol_progress.png"));
    /*
     * Solve the problem.
     *
     *
    ...
    solPlotter.plot("output/solomon_C101_specifiedVehicleEndLocations_withoutTWs_solution.png",
        "C101");
