...
public class SimpleEnRoutePickupAndDeliveryOpenRoutesExample {
  ...
  public static void main(String[] args) {
    ...
    problemPlotter.plot("output/simpleEnRoutePickupAndDeliveryExample_problem.png",
    ...
    solutionPlotter.plot("output/simpleEnRoutePickupAndDeliveryExample_solution.png",
        "en-route pickup and delivery");

    new GraphStreamViewer(problem, bestSolution).setRenderShipments(true).setRenderDelay(100)
        .display();
  }
