...
public class MultipleTimeWindowExample2 {
  ...
  public static void main(String[] args) {
    ...
    VehicleTypeImpl.Builder vehicleTypeBuilder = VehicleTypeImpl.Builder.newInstance("vehicleType")
        .addCapacityDimension(0, 60).setCostPerWaitingTime(0.8);
    ...
    for (int i = 0; i < 40; i++) {
      Service service = Service.Builder.newInstance("" + (i + 1))
          .addTimeWindow(random.nextInt(50), 200).addTimeWindow(220 + random.nextInt(50), 350)
    ...
    for (int i = 0; i < 12; i++) {
      Service service = Service.Builder.newInstance("" + (i + 51))
          ...
          // .addSizeDimension(0, 1)
          .setServiceTime(2)
          .setLocation(Location.newInstance(50 + random.nextInt(20), 20 + random.nextInt(25)))
          .build();
      vrpBuilder.addJob(service);
    }

    Service service = Service.Builder.newInstance("100").addTimeWindow(50, 80).setServiceTime(10)
