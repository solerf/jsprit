...
public class BelhaizaReaderTest {
  ...
  public void firstTimeWindowShouldBeCorrect() {
    ...
    VehicleRoutingProblem vrp = builder.build();
    assertEquals(20.,
        ((Service) vrp.getJobs().get("1")).getTimeWindows().iterator().next().getStart(), 0.1);
    assertEquals(31.,
        ((Service) vrp.getJobs().get("1")).getTimeWindows().iterator().next().getEnd(), 0.1);
  }
  ...
  public void secondTimeWindowShouldBeCorrect() {
    ...
    List<TimeWindow> timeWindows =
        new ArrayList<TimeWindow>(((Service) vrp.getJobs().get("1")).getTimeWindows());
  ...
  public void testAlgo() {
    ...
    // VariationCoefficientTermination variation_coefficient = new
    // VariationCoefficientTermination(200, 0.005);
