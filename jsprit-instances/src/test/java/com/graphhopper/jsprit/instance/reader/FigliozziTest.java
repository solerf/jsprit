...
public class FigliozziTest {
  ...
  public void whenConstantTimeDistribution_forwardTimeShouldBeCalculate100() {
    ...
    Assert.assertEquals(100., tdCosts.getTransportTime(loc("from"), loc("to"), 0., null, null),
        0.01);
  }
  ...
  public void whenTimeDistributionTD1a_forwardTimeShouldBeCalculate100() {
    ...
    /*
     * 100 (0,20) - 1. --> 20 (20,40) 1.6 = s/t --> t = s / 1.6 = 20 * 1.6 = 32 : 52 --> 40 (40,60)
     * 1.05 = 21 : 73 --> 60 (60,80) 1.6 = 20 * 1.6 = 32 --> 27 / 1.6 = 16.875 + 73 = -- 16.875
     * 
     * 20
     * 
     */
    Assert.assertEquals(76.875, tdCosts.getTransportTime(loc("from"), loc("to"), 0., null, null),
        0.01);
  }
  ...
  public void whenTimeDistributionTD2a_forwardTimeShouldBeCalculate100() {
    ...
    /*
     * 100 (0,20) - 1. --> 20 dist, 20 time (20,40) 2. = 20 --> 40 dist, 20 time : 60 dist, 40 time
     * (40,60) 1.5 = 30 dist, 20 time : 90 dist, 60 time (60,80) 2. = 10 dist, 5 time : 100 dist, 65
     * time
     * 
     * 20
     * 
     */
    Assert.assertEquals(65., tdCosts.getTransportTime(loc("from"), loc("to"), 0., null, null),
        0.01);
  }
  ...
  public void whenTimeDistributionTD3a_forwardTimeShouldBeCalculate100() {
    ...
    /*
     * 100 (0,20) - 1. --> 20 dist, 20 time (20,40) 2.5 = 20 --> 50 dist, 20 time : 70 dist, 40 time
     * (40,60) 1.75 = 30 dist, 17.1428571429 time : 100 dist, 57.1428571429 time
     */
    Assert.assertEquals(57.1428571429,
        tdCosts.getTransportTime(loc("from"), loc("to"), 0., null, null), 0.01);
  }
  ...
  public void whenTimeDistributionTD2a_backwardTimeShouldBeCalculate100() {
    ...
    Assert.assertEquals(65.,
        tdCosts.getBackwardTransportTime(loc("from"), loc("to"), 100., null, null), 0.01);
  }
