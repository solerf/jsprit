 ...
 * http://mistic.heig-vd.ch/taillard/problemes.dir/vrp.dir/vrp.html. You can find the modified
 * version here: jsprit-instances/instances/vrph.
 * <p>
 * <p>
...
public class VrphGoldenReader {
   ...
   * <p>
   * <b>FSMF</b> - Fleet Size and Mix with Fixed costs
   * <p>
   * <b>FSMFD</b> - Fleet Size and Mix with Fixed and Dependent costs
   * <p>
   * <b>HVRPD</b> - Heterogeneous Vehicle Routing Problem with Dependent costs and finite (limited)
   * fleet
   * <p>
   * <b>HVRPFD</b> - Heterogeneous Vehicle Routing Problem with Fixed and Dependent costs and finite
   * (limited) fleet
   *
   * @author schroeder
   */
  public enum VrphType {
    FSMD, HVRPD, FSMF, FSMFD, HVRPFD
  }
    ...
    while ((line = readLine(reader)) != null) {
      ...
      if (firstline) {
        ...
        if (customerCount == 0) {
          ...
          Service.Builder serviceBuilder = Service.Builder.newInstance(tokens[0])
              .addSizeDimension(0, Integer.parseInt(tokens[3]));
          serviceBuilder.setLocation(
              Location.newInstance(Double.parseDouble(tokens[1]), Double.parseDouble(tokens[2])));
        ...
        VehicleTypeImpl.Builder typeBuilder = VehicleTypeImpl.Builder
            .newInstance("type_" + tokens[1]).addCapacityDimension(0, Integer.parseInt(tokens[2]));
        int nuOfVehicles = 1;
