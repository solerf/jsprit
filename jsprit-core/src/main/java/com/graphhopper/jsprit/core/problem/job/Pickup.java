...
/**
 * Pickup extends Service and is intended to model a Service where smth is LOADED (i.e. picked up)
 * to a transport unit.
 *
 * @author schroeder
 */
  ...
  public static class Builder extends Service.Builder<Pickup> {
    ...
    public Builder setMaxTimeInVehicle(double maxTimeInVehicle) {
      throw new UnsupportedOperationException(
          "maxTimeInVehicle is not yet supported for Pickups and Services (only for Deliveries and Shipments)");
    ...
    public Pickup build() {
      ...
      super.activity = new Activity.Builder(location, Activity.Type.PICKUP)
          .setTimeWindows(timeWindows.getTimeWindows()).setServiceTime(serviceTime).build();
