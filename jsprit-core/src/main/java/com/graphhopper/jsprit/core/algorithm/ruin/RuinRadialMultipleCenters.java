...
public final class RuinRadialMultipleCenters extends AbstractRuinStrategy {
  ...
  public RuinRadialMultipleCenters(VehicleRoutingProblem vrp, int neighborhoodSize,
  ...
  private Collection<Job> ruinRoutes_(Collection<VehicleRoute> vehicleRoutes, Job targetJob,
      int nOfJobs2BeRemoved, Set<Job> available) {
