...
public class VehicleRoutingProblemSolution {
  ...
  /**
   * Constructs a solution with a number of {@link VehicleRoute}s and their corresponding aggregate
   * cost value.
   *
   * @param routes routes being part of the solution
   * @param cost total costs of solution
   */
  public VehicleRoutingProblemSolution(String problemId, Collection<VehicleRoute> routes,
      double cost) {
    super();
  ...
  /**
   * Constructs a solution with a number of {@link VehicleRoute}s, bad jobs and their corresponding
   ...
   */
  public VehicleRoutingProblemSolution(String problemId, Collection<VehicleRoute> routes,
      Collection<Job> unassignedJobs, double cost) {
    super();
    this.problemId = problemId;
    this.routes = routes;
  ...
  public String toString() {
    return "[problemId=" + problemId + "][costs=" + cost + "][routes=" + routes.size()
