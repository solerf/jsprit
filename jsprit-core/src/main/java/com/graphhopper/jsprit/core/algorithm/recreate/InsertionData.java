...
/**
 * Data object that collects insertion information. It collects insertionCosts, insertionIndeces,
 * vehicle and driver to be employed and departureTime of vehicle at vehicle's start location (e.g.
 * depot).
 *
 * @author stefan
 */
public class InsertionData {
  ...
  /**
   * Returns an instance of InsertionData that represents an EmptyInsertionData (which might
   * indicate that no insertion has been found). It is internally instantiated as follows:<br>
  ...
  public InsertionData(double insertionCost, int pickupInsertionIndex, int deliveryInsertionIndex,
  ...
  public String toString() {
    return "[iCost=" + insertionCost + "][pickupIndex=" + pickupInsertionIndex + "][deliveryIndex="
        + deliveryInsertionIndex + "][depTime=" + departureTime + "][vehicle=" + selectedVehicle
        + "][driver=" + selectedDriver + "]";
  }

  /**
   * Returns insertionIndex of deliveryActivity. If no insertionPosition is found, it returns
   * NO_INDEX (=-1).
   *
   * @return
   */
  ...
  /**
   * Returns insertionIndex of pickkupActivity. If no insertionPosition is found, it returns
   * NO_INDEX (=-1).
   *
   * @return
   */
  ...
  /**
   * Returns insertion costs (which might be the additional costs of inserting the corresponding
   * job).
   *
   * @return
   */
