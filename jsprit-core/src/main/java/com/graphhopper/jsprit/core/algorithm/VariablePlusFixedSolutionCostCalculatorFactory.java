...
/**
 * Default objective function which is the sum of all fixed vehicle and variable transportation
 * costs, i.e. each is generated solution is evaluated according this objective function.
 *
 * @author schroeder
 */
