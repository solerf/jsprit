 ...
 * <p>
 * <p>
 * If the distance between two jobs cannot be calculated with input-transport costs, it tries the
 * euclidean distance between these jobs.
 *
...
public class AvgServiceAndShipmentDistance implements JobDistance {
  ...
  private double calcDist(Location location_i, Location location_j) {
    ...
    return EuclideanDistanceCalculator.calculateDistance(location_i.getCoordinate(),
        location_j.getCoordinate());
  }
}
