 ...
 * <p>
 * <p>
 * By default serviceTimes of both pickup and delivery is 0.0 and timeWindows of both is [0.0,
 * Double.MAX_VALUE],
 * <p>
 * <p>
 * A shipment can be built with a builder. You can get an instance of the builder by coding
 * <code>Shipment.Builder.newInstance(...)</code>. This way you can specify the shipment. Once you
 * build the shipment, it is immutable, i.e. fields/attributes cannot be changed anymore and you can
 * only 'get' the specified values.
 * <p>
 * <p>
...
public class Shipment extends AbstractJob {
  ...
  public static class Builder {
    ...
    public Builder addSizeDimension(int dimensionIndex, int dimensionValue) {
      if (dimensionValue < 0)
        throw new IllegalArgumentException(
            "The capacity value must not be negative, but is " + dimensionValue + ".");
     ...
     *
     * @return shipment
     * @throws IllegalArgumentException if neither pickup-location nor pickup-coord is set or if
    ...
    public Shipment build() {
      ...
      pickup = new Activity.Builder(pickupLocation_, Activity.Type.PICKUP)
          .setServiceTime(pickupServiceTime).setTimeWindows(pickupTimeWindows.getTimeWindows())
          .build();
      delivery = new Activity.Builder(deliveryLocation_, Activity.Type.DELIVERY)
          .setServiceTime(deliveryServiceTime).setTimeWindows(deliveryTimeWindows.getTimeWindows())
          .build();
    ...
    public Builder setPriority(int priority) {
      if (priority < 1 || priority > 10)
        throw new IllegalArgumentException(
            "The priority value is not valid. Only 1 (very high) to 10 (very low) are allowed.");
