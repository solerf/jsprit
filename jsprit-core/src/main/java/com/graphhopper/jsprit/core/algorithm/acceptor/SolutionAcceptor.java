...
public interface SolutionAcceptor {
   ...
   * <p>
   * <p>
   * If the solution is accepted, it is added to solutions, i.e. the solutions-collections is
   * modified.
   *
   ...
   */
  boolean acceptSolution(Collection<VehicleRoutingProblemSolution> solutions,
