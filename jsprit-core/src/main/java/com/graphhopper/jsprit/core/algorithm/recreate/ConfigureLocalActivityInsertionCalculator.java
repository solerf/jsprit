...
public class ConfigureLocalActivityInsertionCalculator
    implements InsertionStartsListener, JobInsertedListener {
  ...
  public ConfigureLocalActivityInsertionCalculator(VehicleRoutingProblem vrp,
  ...
  public void informInsertionStarts(Collection<VehicleRoute> vehicleRoutes,
    ...
    double completenessRatio =
        (1 - ((double) nuOfJobsToRecreate / (double) vrp.getJobs().values().size()));
    localActivityInsertionCostsCalculator
        .setSolutionCompletenessRatio(Math.max(0.5, completenessRatio));
  }
