...
/**
 * Terminates algorithm prematurely based on iterations without any improvement (i.e. new solution
 * acceptance).
 * <p>
 * <p>
 * Termination will be activated by:<br>
 * <p>
...
public class IterationWithoutImprovementTermination implements PrematureAlgorithmTermination {
  ...
  private static final Logger log =
      LoggerFactory.getLogger(IterationWithoutImprovementTermination.class);
  ...
  public String toString() {
    return "[name=IterationWithoutImprovementBreaker][iterationsWithoutImprovement="
        + noIterationWithoutImprovement + "]";
  }
