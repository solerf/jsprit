...
public class JobInsertionCostsCalculatorBuilder {
  ...
  private static class CalculatorPlusListeners {
    ...
    private final List<PrioritizedVRAListener> algorithmListener =
        new ArrayList<PrioritizedVRAListener>();
  ...
  private JobInsertionCostsCalculatorFactory shipmentCalculatorFactory =
      new ShipmentInsertionCalculatorFactory();

  private JobInsertionCostsCalculatorFactory serviceCalculatorFactory =
      new ServiceInsertionCalculatorFactory();

  private JobInsertionCostsCalculatorFactory breakCalculatorFactory =
      new BreakInsertionCalculatorFactory();

  /**
   * Constructs the builder.
   * <p>
   * <p>
   * Some calculators require information from the overall algorithm or the higher-level insertion
   * procedure. Thus listeners inform them. These listeners are cached in the according list and can
   * thus be added when its time to add them.
   *
   * @param insertionListeners
   * @param algorithmListeners
   */
  public JobInsertionCostsCalculatorBuilder(List<InsertionListener> insertionListeners,
  ...
  public JobInsertionCostsCalculatorBuilder setShipmentCalculatorFactory(
      JobInsertionCostsCalculatorFactory shipmentCalculatorFactory) {
  ...
  public JobInsertionCostsCalculatorBuilder setServiceCalculatorFactory(
      JobInsertionCostsCalculatorFactory serviceCalculatorFactory) {
  ...
  public JobInsertionCostsCalculatorBuilder setBreakCalculatorFactory(
      JobInsertionCostsCalculatorFactory breakCalculatorFactory) {
   ...
   * @return
   */
  public JobInsertionCostsCalculatorBuilder setStateManager(
   ...
   * @return
   */
  public JobInsertionCostsCalculatorBuilder setVehicleRoutingProblem(
   ...
   * @return
   */
  public JobInsertionCostsCalculatorBuilder setVehicleFleetManager(
  ...
  public JobInsertionCostsCalculatorBuilder setActivityInsertionCostsCalculator(
   ...
   */
  public JobInsertionCostsCalculatorBuilder setRouteLevel(int forwardLooking, int memory,
      boolean addDefaultMarginalCostCalc) {
    local = false;
  ...
  /**
   * Sets a flag to consider also fixed-cost when evaluating the insertion of a job. The weight of
   * the fixed-cost can be determined by setting weightofFixedCosts.
   *
  ...
  public JobInsertionCostsCalculatorBuilder experimentalTimeScheduler(double timeSlice,
      int neighbors) {
    timeScheduling = true;
  ...
  public JobInsertionCostsCalculator build() {
    if (vrp == null)
      throw new IllegalStateException(
          "vehicle-routing-problem is null, but it must be set (this.setVehicleRoutingProblem(vrp))");
    if (states == null)
      throw new IllegalStateException(
          "states is null, but is must be set (this.setStateManager(states))");
    if (fleetManager == null)
      throw new IllegalStateException(
          "fleetManager is null, but it must be set (this.setVehicleFleetManager(fleetManager))");
    ...
    if (considerFixedCost) {
      // CalculatorPlusListeners withFixed = createCalculatorConsideringFixedCosts(vrp,
      // baseCalculator, states, weightOfFixedCost);
    ...
    if (timeScheduling) {
      ...
      CalculatesServiceInsertionWithTimeScheduling wts =
          new CalculatesServiceInsertionWithTimeScheduling(baseCalculator, timeSlice, neighbors);
      CalculatorPlusListeners calcPlusListeners = new CalculatorPlusListeners(wts);
      calcPlusListeners.getInsertionListener()
          .add(new CalculatesServiceInsertionWithTimeScheduling.KnowledgeInjection(wts));
  ...
  private CalculatorPlusListeners createStandardLocal(final VehicleRoutingProblem vrp,
      RouteAndActivityStateGetter statesManager) {
    ...
    if (activityInsertionCostCalculator == null && addDefaultCostCalc) {
      actInsertionCalc = new LocalActivityInsertionCostsCalculator(vrp.getTransportCosts(),
          vrp.getActivityCosts(), statesManager);
      configLocal = new ConfigureLocalActivityInsertionCalculator(vrp,
          (LocalActivityInsertionCostsCalculator) actInsertionCalc);
    } else if (activityInsertionCostCalculator == null && !addDefaultCostCalc) {
      actInsertionCalc = new ActivityInsertionCostsCalculator() {

        @Override
        public double getCosts(JobInsertionContext iContext, TourActivity prevAct,
            TourActivity nextAct, TourActivity newAct, double depTimeAtPrevAct) {
          return 0.;
        }
    ...
    JobInsertionCostsCalculator shipmentInsertion =
        shipmentCalculatorFactory.create(vrp, actInsertionCalc, activityFactory, constraintManager);
    JobInsertionCostsCalculator serviceInsertion =
        serviceCalculatorFactory.create(vrp, actInsertionCalc, activityFactory, constraintManager);
    JobInsertionCostsCalculator breakInsertion =
        breakCalculatorFactory.create(vrp, actInsertionCalc, activityFactory, constraintManager);
  ...
  private CalculatorPlusListeners createStandardRoute(final VehicleRoutingProblem vrp,
      RouteAndActivityStateGetter activityStates2, int forwardLooking, int solutionMemory) {
    ActivityInsertionCostsCalculator routeLevelCostEstimator;
    if (activityInsertionCostCalculator == null && addDefaultCostCalc) {
      RouteLevelActivityInsertionCostsEstimator routeLevelActivityInsertionCostsEstimator =
          new RouteLevelActivityInsertionCostsEstimator(vrp.getTransportCosts(),
              vrp.getActivityCosts(), activityStates2);
    ...
    ServiceInsertionOnRouteLevelCalculator jobInsertionCalculator =
        new ServiceInsertionOnRouteLevelCalculator(vrp.getTransportCosts(), vrp.getActivityCosts(),
            routeLevelCostEstimator, constraintManager, constraintManager);
  ...
  private JobInsertionCostsCalculator createFinalInsertion(VehicleFleetManager fleetManager,
      JobInsertionCostsCalculator baseCalc, RouteAndActivityStateGetter activityStates2) {
    VehicleTypeDependentJobInsertionCalculator vehicleTypeDependentJobInsertionCalculator =
  ...
  public JobInsertionCostsCalculatorBuilder setConstraintManager(
