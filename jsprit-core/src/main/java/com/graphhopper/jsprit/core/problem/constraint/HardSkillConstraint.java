...
/**
 * SkillConstraint that ensures that only vehicles with according skills can serve route and job to
 * be inserted.
 */
public class HardSkillConstraint implements HardRouteConstraint {
  ...
  public boolean fulfilled(JobInsertionContext insertionContext) {
    ...
    Skills requiredSkillsForRoute =
        states.getRouteState(insertionContext.getRoute(), InternalStates.SKILLS, Skills.class);
