 ...
 * <p>
 * <p>
 * Two vehicles are equal if they share the same type, the same start and end-location and the same
...
public class VehicleTypeKey extends AbstractVehicle.AbstractTypeKey {
  ...
  public VehicleTypeKey(String typeId, String startLocationId, String endLocationId,
      double earliestStart, double latestEnd, Skills skills, boolean returnToDepot) {
    super();
    this.type = typeId;
  ...
  public String toString() {
    return type + "_" + startLocationId + "_" + endLocationId + "_" + earliestStart + "_"
        + latestEnd;
  }
