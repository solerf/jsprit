...
public class Time {
   ...
   * <p>
   * <p>
   * timeString can be 6AM, 06AM, 6 am, 6:01AM, 6:1 pM, 6:12:1 pm, 6:12:01 am, 06:12:01 Pm etc. -
   * but not more precise than seconds.
   * <p>
   * example: 12 AM returns 12*3600. sec 6:30 AM --> 6*3600. + 30*60. 0:30:20 AM --> 30*3600. + 20.
   * 6:00 PM --> 6*3600. + 12.*3600. 6:00:12 --> 6*3600. + 12.
   *
   * @return seconds
   */
  public static double parseTimeToSeconds(String timeString) {
    ...
    if (tokens.length == 1) { // 1 AM or 01 AM
      ...
      return getHourInSeconds(tokens[0]) + getMinInSeconds(tokens[1])
          + getSecondsInSeconds(tokens[2]) + dayTime;
    } else {
