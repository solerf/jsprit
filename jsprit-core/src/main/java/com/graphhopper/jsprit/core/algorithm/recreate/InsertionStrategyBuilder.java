...
public class InsertionStrategyBuilder {
  ...
  public InsertionStrategyBuilder(VehicleRoutingProblem vrp,
  ...
  public InsertionStrategyBuilder setShipmentInsertionCalculatorFactory(
      JobInsertionCostsCalculatorFactory shipmentInsertionCalculatorFactory) {
    this.shipmentInsertionCalculatorFactory = shipmentInsertionCalculatorFactory;
    return this;
  }

  public InsertionStrategyBuilder setServiceInsertionCalculator(
      JobInsertionCostsCalculatorFactory serviceInsertionCalculator) {
    this.serviceInsertionCalculatorFactory = serviceInsertionCalculator;
    return this;
  }

  public InsertionStrategyBuilder setBreakInsertionCalculator(
      JobInsertionCostsCalculatorFactory breakInsertionCalculator) {
  ...
  /**
   * If addDefaulMarginalCostCalculation is false, no calculator is set which implicitly assumes
   * that marginal cost calculation is controlled by your custom soft constraints.
   *
  ...
  public InsertionStrategyBuilder setActivityInsertionCostCalculator(
  ...
  public InsertionStrategy build() {
    ...
    List<VehicleRoutingAlgorithmListeners.PrioritizedVRAListener> algorithmListeners =
        new ArrayList<VehicleRoutingAlgorithmListeners.PrioritizedVRAListener>();
    JobInsertionCostsCalculatorBuilder calcBuilder =
        new JobInsertionCostsCalculatorBuilder(iListeners, algorithmListeners);
    if (local) {
    ...
    if (strategy.equals(Strategy.BEST)) {
      ...
      if (executor == null) {
        ...
        if (isFastRegret) {
          RegretInsertionConcurrentFast regret =
              new RegretInsertionConcurrentFast(costCalculator, vrp, executor, fleetManager);
          regret.setSwitchAllowed(allowVehicleSwitch);
          insertion = regret;
        } else {
          RegretInsertionConcurrent regret =
              new RegretInsertionConcurrent(costCalculator, vrp, executor);
          insertion = regret;
        }
