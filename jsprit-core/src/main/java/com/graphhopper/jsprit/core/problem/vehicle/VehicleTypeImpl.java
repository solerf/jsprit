...
public class VehicleTypeImpl implements VehicleType {
  ...
  /**
   * CostParameter consisting of fixed cost parameter, time-based cost parameter and distance-based
   * cost parameter.
   *
   * @author schroeder
   */
  public static class VehicleCostParams {
    ...
    public static VehicleTypeImpl.VehicleCostParams newInstance(double fix, double perTimeUnit,
    ...
    public VehicleCostParams(double fix, double perTimeUnit, double perDistanceUnit,
        double perWaitingTimeUnit) {
      this.fix = fix;
      this.perTransportTimeUnit = perTimeUnit;
      this.perDistanceUnit = perDistanceUnit;
    ...
    public VehicleCostParams(double fix, double perTimeUnit, double perDistanceUnit,
        double perWaitingTimeUnit, double perServiceTimeUnit) {
      this.fix = fix;
      this.perTransportTimeUnit = perTimeUnit;
      this.perDistanceUnit = perDistanceUnit;
      this.perWaitingTimeUnit = perWaitingTimeUnit;
    ...
    public String toString() {
      return "[fixed=" + fix + "][perTime=" + perTransportTimeUnit + "][perDistance="
          + perDistanceUnit + "][perWaitingTimeUnit=" + perWaitingTimeUnit + "]";
    }
    ...
    public boolean equals(Object o) {
      ...
      if (Double.compare(that.fix, fix) != 0)
        return false;
      if (Double.compare(that.perTransportTimeUnit, perTransportTimeUnit) != 0)
        return false;
      if (Double.compare(that.perDistanceUnit, perDistanceUnit) != 0)
        return false;
      if (Double.compare(that.perWaitingTimeUnit, perWaitingTimeUnit) != 0)
        return false;
  ...
  public static class Builder {
    ...
    public VehicleTypeImpl.Builder setMaxVelocity(double inMeterPerSeconds) {
      if (inMeterPerSeconds < 0.0)
        throw new IllegalArgumentException(
            "The velocity of a vehicle (type) cannot be smaller than zero.");
    ...
    public Builder addCapacityDimension(int dimIndex, int dimVal) {
      ...
      if (capacityDimensions != null)
        throw new IllegalArgumentException(
            "Either build your dimension with build your dimensions with "
     ...
     * <code>addCapacityDimension(int dimIndex, int dimVal)</code> anymore. Thus either build your
     * dimensions with <code>addCapacityDimension(int dimIndex, int dimVal)</code> or set the
     * already built dimensions with this method.
     *
  ...
  public boolean equals(Object o) {
    ...
    if (Double.compare(that.maxVelocity, maxVelocity) != 0)
      return false;
    if (!typeId.equals(that.typeId))
      return false;
    if (profile != null ? !profile.equals(that.profile) : that.profile != null)
      return false;
    if (!vehicleCostParams.equals(that.vehicleCostParams))
      return false;
  ...
  private VehicleTypeImpl(VehicleTypeImpl.Builder builder) {
    ...
    vehicleCostParams = new VehicleCostParams(builder.fixedCost, builder.perTime,
        builder.perDistance, builder.perWaitingTime, builder.perServiceTime);
  ...
  @Override
  public String toString() {
    return "[typeId=" + typeId + "]" + "[capacity=" + capacityDimensions + "]" + "[costs="
        + vehicleCostParams + "]";
  }
