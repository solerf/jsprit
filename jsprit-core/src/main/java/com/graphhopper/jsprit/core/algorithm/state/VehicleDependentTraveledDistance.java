...
public class VehicleDependentTraveledDistance implements StateUpdater, ActivityVisitor {
  ...
  public VehicleDependentTraveledDistance(TransportDistance transportCostMatrices,
      StateManager stateManager, StateId distanceInRouteId, Collection<Vehicle> vehicles) {
  ...
  public void visit(TourActivity activity) {
    for (Vehicle v : uniqueVehicles) {
      ...
      distance +=
          transportDistance.getDistance(old.getPrevLocation(), activity.getLocation(), 0, v);
