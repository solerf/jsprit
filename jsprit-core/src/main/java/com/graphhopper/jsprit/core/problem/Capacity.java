...
public class Capacity {
  ...
  public static double divide(Capacity numerator, Capacity denominator) {
    ...
    for (int index = 0; index < Math.max(numerator.getNuOfDimensions(),
  ...
  public static class Builder {
     ...
     * <p>
     * <p>
     * Note that it automatically resizes dimensions according to index, i.e. if index=7 there are 8
     * dimensions. New dimensions then are initialized with 0
     *
  ...
  public String toString() {
    ...
    for (int i = 0; i < getNuOfDimensions(); i++) {
      string.append("[[dimIndex=").append(i).append("][dimValue=").append(dimensions[i])
          .append("]]");
    }
