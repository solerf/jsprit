...
public class VehicleRoutingProblemSolutionTest {
  ...
  public void whenCreatingSolutionWithTwoRoutes_solutionShouldContainTheseRoutes() {
    ...
    VehicleRoutingProblemSolution sol =
        new VehicleRoutingProblemSolution("any-id", Arrays.asList(r1, r2), 0.0);
  ...
  public void whenSettingSolutionCostsTo10_solutionCostsShouldBe10() {
    VehicleRoutingProblemSolution sol =
        new VehicleRoutingProblemSolution("any-id", Collections.emptyList(), 10.0);
  ...
  public void sizeOfBadJobsShouldBeCorrect() {
    ...
    badJobs.add(badJob);
    VehicleRoutingProblemSolution sol =
        new VehicleRoutingProblemSolution("any-id", Collections.emptyList(), badJobs, 10.0);
