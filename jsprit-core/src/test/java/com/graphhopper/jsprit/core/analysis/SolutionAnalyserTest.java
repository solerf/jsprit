...
public class SolutionAnalyserTest {
  ...
  public void doBefore() {
    ...
    VehicleType type = VehicleTypeImpl.Builder.newInstance("type").setFixedCost(100.)
        .setCostPerDistance(2.).addCapacityDimension(0, 15).build();

    VehicleImpl vehicle = VehicleImpl.Builder.newInstance("v1").setType(type)
        .setStartLocation(Location.newInstance(-5, 0)).addSkill("skill1").addSkill("skill2")
        .build();

    VehicleImpl vehicle2 = VehicleImpl.Builder.newInstance("v2").setType(type)
        .setStartLocation(Location.newInstance(5, 0)).build();

    Service s1 = Service.Builder.newInstance("s1").setTimeWindow(TimeWindow.newInstance(10, 20))
        .setLocation(Location.newInstance(-10, 1)).addSizeDimension(0, 2).addRequiredSkill("skill1")
        .build();
    Service s2 = Service.Builder.newInstance("s2").setLocation(Location.newInstance(-10, 10))
        .addSizeDimension(0, 3).addRequiredSkill("skill2").addRequiredSkill("skill1").build();
    Shipment shipment1 = Shipment.Builder.newInstance("ship1")
        .setPickupLocation(TestUtils.loc(Coordinate.newInstance(-15, 2)))
        .setDeliveryLocation(TestUtils.loc(Coordinate.newInstance(-16, 5))).addSizeDimension(0, 10)
        .setPickupServiceTime(20.).setDeliveryServiceTime(20.).addRequiredSkill("skill3").build();

    Service s3 = Service.Builder.newInstance("s3").setTimeWindow(TimeWindow.newInstance(10, 20))
    ...
    Service s4 = Service.Builder.newInstance("s4")
        .setLocation(TestUtils.loc(Coordinate.newInstance(10, 10))).addSizeDimension(0, 3).build();

    Shipment shipment2 = Shipment.Builder.newInstance("ship2")
        .setPickupLocation(TestUtils.loc(Coordinate.newInstance(15, 2))).setPickupServiceTime(20.)
        .setDeliveryServiceTime(20.)
        .setDeliveryLocation(TestUtils.loc(Coordinate.newInstance(16, 5))).addSizeDimension(0, 10)
        .build();

    VehicleRoutingProblem.Builder vrpBuilder = VehicleRoutingProblem.Builder.newInstance()
        .addVehicle(vehicle).addVehicle(vehicle2).addJob(s1).addJob(s2).addJob(shipment1).addJob(s3)
        .addJob(s4).addJob(shipment2).setFleetSize(VehicleRoutingProblem.FleetSize.INFINITE);
    vrpBuilder.setRoutingCost(new ManhattanCosts(vrpBuilder.getLocations()));
    vrp = vrpBuilder.build();

    VehicleRoute route1 =
        VehicleRoute.Builder.newInstance(vehicle).setJobActivityFactory(vrp.getJobActivityFactory())
  ...
  public void buildAnotherScenarioWithOnlyOneVehicleAndWithoutAnyConstraintsBefore() {
    ...
    VehicleImpl vehicle = VehicleImpl.Builder.newInstance("v1").setType(type)
        .setStartLocation(Location.newInstance(-5, 0)).setLatestArrival(150.).build();

    Pickup s1 = Pickup.Builder.newInstance("s1").setTimeWindow(TimeWindow.newInstance(10, 20))
        .setLocation(Location.newInstance(-10, 1)).addSizeDimension(0, 10).build();
    Delivery s2 = Delivery.Builder.newInstance("s2").setLocation(Location.newInstance(-10, 10))
        .setTimeWindow(TimeWindow.newInstance(10, 20)).addSizeDimension(0, 20).build();
    Shipment shipment1 = Shipment.Builder.newInstance("ship1")
        .setPickupLocation(TestUtils.loc(Coordinate.newInstance(-15, 2)))
        .setDeliveryLocation(TestUtils.loc(Coordinate.newInstance(-16, 5))).addSizeDimension(0, 15)
        .setPickupServiceTime(20.).setDeliveryServiceTime(20.)
        .setPickupTimeWindow(TimeWindow.newInstance(10, 20))
        .setDeliveryTimeWindow(TimeWindow.newInstance(10, 20)).build();

    Pickup s3 = Pickup.Builder.newInstance("s3").setTimeWindow(TimeWindow.newInstance(10, 20))
        .setLocation(TestUtils.loc(Coordinate.newInstance(10, 1))).addSizeDimension(0, 10).build();
    Delivery s4 = Delivery.Builder.newInstance("s4").setLocation(Location.newInstance(10, 10))
        .addSizeDimension(0, 20).setTimeWindow(TimeWindow.newInstance(10, 20)).build();
    Shipment shipment2 = Shipment.Builder.newInstance("ship2")
        .setPickupLocation(TestUtils.loc(Coordinate.newInstance(15, 2))).setPickupServiceTime(20.)
        .setDeliveryServiceTime(20.)
        .setDeliveryLocation(TestUtils.loc(Coordinate.newInstance(16, 5)))
        .setPickupTimeWindow(TimeWindow.newInstance(10, 20))
        .setDeliveryTimeWindow(TimeWindow.newInstance(10, 20)).addSizeDimension(0, 15).build();

    VehicleRoutingProblem.Builder vrpBuilder = VehicleRoutingProblem.Builder.newInstance()
        .addVehicle(vehicle).addJob(s1).addJob(s2).addJob(shipment1).addJob(s3).addJob(s4)
        .addJob(shipment2).setFleetSize(VehicleRoutingProblem.FleetSize.FINITE);
    vrpBuilder.setRoutingCost(new ManhattanCosts(vrpBuilder.getLocations()));
    vrp = vrpBuilder.build();

    VehicleRoute route =
        VehicleRoute.Builder.newInstance(vehicle).setJobActivityFactory(vrp.getJobActivityFactory())
            .addPickup(s3).addPickup(shipment2).addDelivery(shipment2).addDelivery(s4)
            .addDelivery(s2).addPickup(shipment1).addDelivery(shipment1).addPickup(s1).build();
  ...
  private void testTransportCosts(TransportCostsTestType type) {
    ...
    Coordinate[] route1Path =
        new Coordinate[] {Coordinate.newInstance(-5, 0), Coordinate.newInstance(-10, 1),
            Coordinate.newInstance(-15, 2), Coordinate.newInstance(-16, 5),
            Coordinate.newInstance(-10, 10), Coordinate.newInstance(-5, 0)
  ...
  public void loadAfterActivity_ofAct1ofRoute1ShouldWork() {
    ...
    Assert.assertEquals(2,
        analyser.getLoadRightAfterActivity(route.getActivities().get(0), route).get(0));
  }
  ...
  public void loadAfterActivity_ofAct2ofRoute1ShouldWork() {
    ...
    Assert.assertEquals(12,
        analyser.getLoadRightAfterActivity(route.getActivities().get(1), route).get(0));
  }
  ...
  public void loadAfterActivity_ofAct3ofRoute1ShouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(2,
        analyser.getLoadRightAfterActivity(route.getActivities().get(2), route).get(0));
  }
  ...
  public void loadAfterActivity_ofAct4ofRoute1ShouldWork() {
    ...
    Assert.assertEquals(5,
        analyser.getLoadRightAfterActivity(route.getActivities().get(3), route).get(0));
  }
  ...
  public void loadBeforeActivity_ofAct1ofRoute1ShouldWork() {
    ...
    Assert.assertEquals(0,
        analyser.getLoadJustBeforeActivity(route.getActivities().get(0), route).get(0));
  }
  ...
  public void loadBeforeActivity_ofAct2ofRoute1ShouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(2,
        analyser.getLoadJustBeforeActivity(route.getActivities().get(1), route).get(0));
  }
  ...
  public void loadBeforeActivity_ofAct3ofRoute1ShouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(12,
        analyser.getLoadJustBeforeActivity(route.getActivities().get(2), route).get(0));
  }
  ...
  public void loadBeforeActivity_ofAct4ofRoute1ShouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(2,
        analyser.getLoadJustBeforeActivity(route.getActivities().get(3), route).get(0));
  }
  ...
  public void waitingTime_ofAct1ofRoute1ShouldWork() {
    SolutionAnalyser analyser = new SolutionAnalyser(vrp, solution, vrp.getTransportCosts());
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(4., analyser.getWaitingTimeAtActivity(route.getActivities().get(0), route),
        0.01);
  }
  ...
  public void waitingTime_ofAct2ofRoute1ShouldWork() {
    SolutionAnalyser analyser = new SolutionAnalyser(vrp, solution, vrp.getTransportCosts());
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(0., analyser.getWaitingTimeAtActivity(route.getActivities().get(1), route),
        0.01);
  }
  ...
  public void waitingTime_ofAct3ofRoute1ShouldWork() {
    SolutionAnalyser analyser = new SolutionAnalyser(vrp, solution, vrp.getTransportCosts());
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(0., analyser.getWaitingTimeAtActivity(route.getActivities().get(2), route),
        0.01);
  }
  ...
  public void waitingTime_ofAct4ofRoute1ShouldWork() {
    SolutionAnalyser analyser = new SolutionAnalyser(vrp, solution, vrp.getTransportCosts());
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(0., analyser.getWaitingTimeAtActivity(route.getActivities().get(3), route),
        0.01);
  }
  ...
  public void distance_ofAct1ofRoute1ShouldWork() {
    SolutionAnalyser analyser = new SolutionAnalyser(vrp, solution, vrp.getTransportCosts());
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(6., analyser.getDistanceAtActivity(route.getActivities().get(0), route),
        0.01);
  }
  ...
  public void distance_ofAct2ofRoute1ShouldWork() {
    SolutionAnalyser analyser = new SolutionAnalyser(vrp, solution, vrp.getTransportCosts());
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(12., analyser.getDistanceAtActivity(route.getActivities().get(1), route),
        0.01);
  }
  ...
  public void distance_ofAct3ofRoute1ShouldWork() {
    SolutionAnalyser analyser = new SolutionAnalyser(vrp, solution, vrp.getTransportCosts());
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(16., analyser.getDistanceAtActivity(route.getActivities().get(2), route),
        0.01);
  }
  ...
  public void distance_ofAct4ofRoute1ShouldWork() {
    SolutionAnalyser analyser = new SolutionAnalyser(vrp, solution, vrp.getTransportCosts());
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(27., analyser.getDistanceAtActivity(route.getActivities().get(3), route),
        0.01);
  }
  ...
  public void lateArrivalTimes_atStartActOfRoute1ShouldWork() {
    SolutionAnalyser analyser = new SolutionAnalyser(vrp, solution, vrp.getTransportCosts());
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(0, analyser.getTimeWindowViolationAtActivity(route.getStart(), route),
        0.01);
  }
  ...
  public void lateArrivalTimes_ofAct1ofRoute1ShouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(0.,
        analyser.getTimeWindowViolationAtActivity(route.getActivities().get(0), route), 0.01);
  }
  ...
  public void lateArrivalTimes_ofAct2ofRoute1ShouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(0.,
        analyser.getTimeWindowViolationAtActivity(route.getActivities().get(1), route), 0.01);
  }
  ...
  public void lateArrivalTimes_ofAct3ofRoute1ShouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(0.,
        analyser.getTimeWindowViolationAtActivity(route.getActivities().get(2), route), 0.01);
  }
  ...
  public void lateArrivalTimes_ofAct4ofRoute1ShouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(0.,
        analyser.getTimeWindowViolationAtActivity(route.getActivities().get(3), route), 0.01);
  }
  ...
  public void transportCosts_atStartActOfRoute1ShouldWork() {
    SolutionAnalyser analyser = new SolutionAnalyser(vrp, solution, vrp.getTransportCosts());
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(0, analyser.getVariableTransportCostsAtActivity(route.getStart(), route),
        0.01);
  }
  ...
  public void transportCosts_ofEndActOfRoute1ShouldWork() {
    SolutionAnalyser analyser = new SolutionAnalyser(vrp, solution, vrp.getTransportCosts());
    VehicleRoute route = solution.getRoutes().iterator().next();
    Assert.assertEquals(42. * 2.,
        analyser.getVariableTransportCostsAtActivity(route.getEnd(), route), 0.01);
  }
  ...
  public void timeWindowViolationAtAct1_shouldWorkWhenViolated() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Double violation =
        analyser.getTimeWindowViolationAtActivity(route.getActivities().get(0), route);
    assertEquals(0., violation, 0.01);
  }
  ...
  public void timeWindowViolationAtAct2_shouldWorkWhenViolated() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Double violation =
        analyser.getTimeWindowViolationAtActivity(route.getActivities().get(1), route);
  ...
  public void timeWindowViolationAtAct3_shouldWorkWhenViolated() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Double violation =
        analyser.getTimeWindowViolationAtActivity(route.getActivities().get(2), route);
  ...
  public void timeWindowViolationAtAct4_shouldWorkWhenViolated() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Double violation =
        analyser.getTimeWindowViolationAtActivity(route.getActivities().get(3), route);
  ...
  public void timeWindowViolationAtAct5_shouldWorkWhenViolated() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Double violation =
        analyser.getTimeWindowViolationAtActivity(route.getActivities().get(4), route);
  ...
  public void timeWindowViolationAtAct6_shouldWorkWhenViolated() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Double violation =
        analyser.getTimeWindowViolationAtActivity(route.getActivities().get(5), route);
  ...
  public void timeWindowViolationAtAct7_shouldWorkWhenViolated() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Double violation =
        analyser.getTimeWindowViolationAtActivity(route.getActivities().get(6), route);
  ...
  public void timeWindowViolationAtAct8_shouldWorkWhenViolated() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Double violation =
        analyser.getTimeWindowViolationAtActivity(route.getActivities().get(7), route);
  ...
  public void backhaulViolationAtAct1_shouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Boolean violation =
        analyser.hasBackhaulConstraintViolationAtActivity(route.getActivities().get(0), route);
    assertFalse(violation);
  }
  ...
  public void backhaulViolationAtAct2_shouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Boolean violation =
        analyser.hasBackhaulConstraintViolationAtActivity(route.getActivities().get(1), route);
    assertFalse(violation);
  }
  ...
  public void backhaulViolationAtAct3_shouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Boolean violation =
        analyser.hasBackhaulConstraintViolationAtActivity(route.getActivities().get(2), route);
    assertFalse(violation);
  }
  ...
  public void backhaulViolationAtAct4_shouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Boolean violation =
        analyser.hasBackhaulConstraintViolationAtActivity(route.getActivities().get(3), route);
    assertTrue(violation);
  }
  ...
  public void backhaulViolationAtAct5_shouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Boolean violation =
        analyser.hasBackhaulConstraintViolationAtActivity(route.getActivities().get(4), route);
    assertTrue(violation);
  }
  ...
  public void backhaulViolationAtAct6_shouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Boolean violation =
        analyser.hasBackhaulConstraintViolationAtActivity(route.getActivities().get(5), route);
    assertFalse(violation);
  }
  ...
  public void backhaulViolationAtAct7_shouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Boolean violation =
        analyser.hasBackhaulConstraintViolationAtActivity(route.getActivities().get(6), route);
    assertFalse(violation);
  }
  ...
  public void backhaulViolationAtAct8_shouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Boolean violation =
        analyser.hasBackhaulConstraintViolationAtActivity(route.getActivities().get(7), route);
    assertFalse(violation);
  }
  ...
  public void shipmentViolationAtActivity_shouldWorkWhenRemovingDelivery() {
    ...
    Boolean violation =
        analyser.hasShipmentConstraintViolationAtActivity(route.getActivities().get(1), route);
    assertTrue(violation);
  }
  ...
  public void skillViolationAtAct1_shouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Boolean violated =
        analyser.hasSkillConstraintViolationAtActivity(route.getActivities().get(0), route);
    assertFalse(violated);
  }
  ...
  public void skillViolationAtAct2_shouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Boolean violated =
        analyser.hasSkillConstraintViolationAtActivity(route.getActivities().get(1), route);
    assertTrue(violated);
  }
  ...
  public void skillViolationAtAct3_shouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Boolean violated =
        analyser.hasSkillConstraintViolationAtActivity(route.getActivities().get(2), route);
    assertTrue(violated);
  }
  ...
  public void skillViolationAtAct4_shouldWork() {
    ...
    VehicleRoute route = solution.getRoutes().iterator().next();
    Boolean violated =
        analyser.hasSkillConstraintViolationAtActivity(route.getActivities().get(3), route);
    assertFalse(violated);
  }
  ...
  public void shouldWorkWithRouteWithoutActivities() {
    Vehicle vehicle =
        VehicleImpl.Builder.newInstance("vehicle").setStartLocation(Location.newInstance(0, 0))
    ...
    VehicleRoutingProblem vrp =
        VehicleRoutingProblem.Builder.newInstance().addVehicle(vehicle).build();
    VehicleRoutingProblemSolution solution =
        new VehicleRoutingProblemSolution("any-id", Collections.singletonList(vehicleRoute), 0);
