...
public class TestConstraintManager {
  ...
  public void whenGettingConstraintsViaConstructor_theyShouldBeResolvedCorrectly() {
    ...
    ConstraintManager cManager = new ConstraintManager(mock(VehicleRoutingProblem.class),
        mock(RouteAndActivityStateGetter.class), constraints);
  ...
  public void whenAddingSoftRouteConstraint_managerShouldHaveIt() {
    ...
    ConstraintManager man = new ConstraintManager(mock(VehicleRoutingProblem.class),
