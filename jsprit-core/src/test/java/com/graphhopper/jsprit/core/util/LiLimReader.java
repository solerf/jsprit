...
/**
 * test instances for the capacitated vrp with pickup and deliveries and time windows. instances are
 * from li and lim and can be found at: http://www.top.sintef.no/vrp/benchmarks.html
 *
...
public class LiLimReader {
  ...
  public void read(InputStream inputStream) {
    ...
    VehicleTypeImpl type =
        VehicleTypeImpl.Builder.newInstance("type").addCapacityDimension(0, vehicleCapacity)
  ...
  private void buildShipments() {
    ...
    for (Relation rel : relations) {
      ...
      Shipment s = Shipment.Builder.newInstance(counter.toString()).addSizeDimension(0, demand)
          ...
          .setDeliveryServiceTime(customers.get(to).serviceTime).setDeliveryTimeWindow(
      ...
      while ((line = reader.readLine()) != null) {
        ...
        if (firstLine) {
          ...
          customers.put(customerId,
              new CustomerData(coord, startTimeWindow, endTimeWindow, serviceTime));
