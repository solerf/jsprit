...
public class SchrimpfAcceptanceTest {
  ...
  public void setup() {
    ...
    // insert the initial (worst) solution, will be accepted anyway since its the first in the
    // memory
    assertTrue("Solution (initial cost = 2.0) should be accepted since the memory is empty",
        schrimpfAcceptance.acceptSolution(memory, createSolutionWithCost(2.0)));
  }

  @Test
  public void respectsTheZeroThreshold_usingWorstCostSolution() {
    assertFalse("Worst cost solution (2.1 > 2.0) should not be accepted",
        schrimpfAcceptance.acceptSolution(memory, createSolutionWithCost(2.1)));
  }

  @Test
  public void respectsTheZeroThreshold_usingBetterCostSolution() {
    assertTrue("Better cost solution (1.9 < 2.0) should be accepted",
        schrimpfAcceptance.acceptSolution(memory, createSolutionWithCost(1.9)));
  }

  @Test
  public void respectsTheZeroThreshold_usingSameCostSolution() {
    assertFalse("Same cost solution (2.0 == 2.0) should not be accepted",
        schrimpfAcceptance.acceptSolution(memory, createSolutionWithCost(2.0)));
  }
  ...
  public void respectsTheNonZeroThreshold_usingWorstCostSolution() {
    ...
    /*
     * it should be accepted since 2.1 < 2.0 + 0.5 (2.0 is the best solution found so far and 0.5
     * the ini threshold since the threshold of 0.5 allows new solutions to be <0.5 worse than the
     * current best solution
     */
    assertTrue("Worst cost solution (2.1 > 2.0) should be accepted",
        schrimpfAcceptance.acceptSolution(memory, createSolutionWithCost(2.1)));
  }
  ...
  public void respectsTheNonZeroThreshold_usingBetterCostSolution() {
    ...
    assertTrue(
        ...
        schrimpfAcceptance.acceptSolution(memory, createSolutionWithCost(1.0)));
  }
  ...
  public void respectsTheNonZeroThreshold_usingSameCostSolution() {
    schrimpfAcceptance.setInitialThreshold(0.5);
    assertTrue("Same cost solution (2.0 == 2.0) should not be accepted",
        schrimpfAcceptance.acceptSolution(memory, createSolutionWithCost(2.0)));
  }
  ...
  public void whenIniThresholdIsSetAndCurrentIterationIs0_itShouldJustAcceptSolution() {
    schrimpfAcceptance.setInitialThreshold(0.5);
    schrimpfAcceptance.informIterationStarts(0, mock(VehicleRoutingProblem.class),
  ...
  public void whenIniThresholdIsSetAndCurrentIterationIs500_itShouldJustAcceptSolution() {
    ...
    schrimpfAcceptance.setInitialThreshold(0.5);
    schrimpfAcceptance.informIterationStarts(500, mock(VehicleRoutingProblem.class),
        Collections.emptyList());
    // according to the acceptance-function, it should just accept every solution less than 2.0 +
    // 0.15749013123
  ...
  public void whenIniThresholdIsSetAndCurrentIterationIs1000_itShouldJustAcceptSolution() {
    // 1000 is the default totalNuOfIterations
    schrimpfAcceptance.setInitialThreshold(0.5);
    schrimpfAcceptance.informIterationStarts(1000, mock(VehicleRoutingProblem.class),
        Collections.emptyList());
    // according to the acceptance-function, it should just accept every solution less than 2.0 +
    // 0.04960628287
