...
public class TestMixedServiceAndShipmentsProblemOnRouteLevel {
  ...
  public void whenHavingShipmentsAndServicesInOneProblem_andInsertionShouldBeMadeOnRouteLevel_throwException() {
    ...
    Shipment shipment1 = Shipment.Builder.newInstance("1").addSizeDimension(0, 1)
        ...
        .setDeliveryLocation(TestUtils.loc(Coordinate.newInstance(6, 9))).build();
    Shipment shipment2 = Shipment.Builder.newInstance("2").addSizeDimension(0, 1)
        ...
        .setDeliveryLocation(TestUtils.loc(Coordinate.newInstance(6, 11))).build();
    ...
    Shipment shipment3 = Shipment.Builder.newInstance("3").addSizeDimension(0, 1)
        ...
        .setDeliveryLocation(TestUtils.loc(Coordinate.newInstance(14, 9))).build();
    Shipment shipment4 = Shipment.Builder.newInstance("4").addSizeDimension(0, 1)
        ...
        .setDeliveryLocation(TestUtils.loc(Coordinate.newInstance(14, 11))).build();

    /*
     * build deliveries, (implicitly picked up in the depot) 1: (4,8) 2: (4,12) 3: (16,8) 4: (16,12)
     */
    Delivery delivery1 = Delivery.Builder.newInstance("5").addSizeDimension(0, 1)
        .setLocation(TestUtils.loc(Coordinate.newInstance(4, 8))).build();
    Delivery delivery2 = Delivery.Builder.newInstance("6").addSizeDimension(0, 1)
        .setLocation(TestUtils.loc(Coordinate.newInstance(4, 12))).build();
    Delivery delivery3 = Delivery.Builder.newInstance("7").addSizeDimension(0, 1)
        .setLocation(TestUtils.loc(Coordinate.newInstance(16, 8))).build();
    Delivery delivery4 = Delivery.Builder.newInstance("8").addSizeDimension(0, 1)
        .setLocation(TestUtils.loc(Coordinate.newInstance(16, 12))).build();
  ...
  public void whenHavingOnlyServicesInOneProblem_andInsertionShouldBeMadeOnRouteLevel_itShouldAssertTrue() {
     ...
     */
    Delivery delivery1 = Delivery.Builder.newInstance("5").addSizeDimension(0, 1)
        .setLocation(Location.newInstance(4, 8)).build();
    Delivery delivery2 = Delivery.Builder.newInstance("6").addSizeDimension(0, 1)
        .setLocation(Location.newInstance(4, 12)).build();
    Delivery delivery3 = Delivery.Builder.newInstance("7").addSizeDimension(0, 1)
        .setLocation(Location.newInstance(16, 8)).build();
    Delivery delivery4 = Delivery.Builder.newInstance("8").addSizeDimension(0, 1)
        .setLocation(Location.newInstance(16, 12)).build();
