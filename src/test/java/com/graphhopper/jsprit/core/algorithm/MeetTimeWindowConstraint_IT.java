...
public class MeetTimeWindowConstraint_IT {
  ...
  public void doBefore() {
    ...
    VehicleImpl vehicle1 =
        VehicleImpl.Builder.newInstance("21").setStartLocation(Location.newInstance(0, 0))
            .setEarliestStart(14400).setLatestArrival(46800).setType(type1).build();
    VehicleImpl vehicle2 =
        VehicleImpl.Builder.newInstance("19").setStartLocation(Location.newInstance(0, 0))
    ...
    Service service2 =
        Service.Builder.newInstance("1").setLocation(Location.newInstance(1000, 1000))
    ...
    vrp = VehicleRoutingProblem.Builder.newInstance().addVehicle(vehicle1).addVehicle(vehicle2)
        .addJob(service1).addJob(service2).setFleetSize(VehicleRoutingProblem.FleetSize.FINITE)
        .build();
  }
  ...
  public void whenEmployingVehicleWithDifferentWorkingShifts_certainVehiclesCanNeverBeAssignedToCertainRoutes() {
    ...
    vra.addListener(new VehicleSwitchedListener() {
      ...
      @Override
      public void vehicleSwitched(VehicleRoute vehicleRoute, Vehicle oldVehicle,
          Vehicle newVehicle) {
        if (oldVehicle == null)
          return;
  ...
  public void whenEmployingVehicleWithDifferentWorkingShifts_and_vehicleSwitchIsNotAllowed_nRoutesShouldBeCorrect() {
    VehicleRoutingAlgorithm vra = Jsprit.Builder.newInstance(vrp)
        .setProperty(Jsprit.Parameter.VEHICLE_SWITCH, "false").buildAlgorithm();
    vra.setMaxIterations(100);
    Collection<VehicleRoutingProblemSolution> solutions = vra.searchSolutions();
  ...
  private FastVehicleRoutingTransportCostsMatrix createMatrix() throws IOException {
    BufferedReader reader =
        new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("matrix.txt")));
    String line;
    FastVehicleRoutingTransportCostsMatrix.Builder builder =
        FastVehicleRoutingTransportCostsMatrix.Builder.newInstance(11, false);
    while ((line = reader.readLine()) != null) {
      String[] split = line.split("\t");
      builder.addTransportDistance(Integer.parseInt(split[0]), Integer.parseInt(split[1]),
          Double.parseDouble(split[2]));
      builder.addTransportTime(Integer.parseInt(split[0]), Integer.parseInt(split[1]),
  ...
  private VehicleRoute getRoute(String vehicleId,
      VehicleRoutingProblemSolution vehicleRoutingProblemSolution) {
  ...
  private VehicleRoutingProblem createTWBugProblem() throws IOException {
    ...
    VehicleImpl v0 =
        VehicleImpl.Builder.newInstance("vehicle0").setStartLocation(Location.newInstance(0))
            .setEarliestStart(60).setLatestArrival(18060).setType(type).build();
    VehicleImpl v1 =
        VehicleImpl.Builder.newInstance("vehicle1").setStartLocation(Location.newInstance(0))
            .setEarliestStart(60).setLatestArrival(18060).setType(type).build();
    VehicleImpl v2 =
        VehicleImpl.Builder.newInstance("vehicle2").setStartLocation(Location.newInstance(0))
            .setEarliestStart(7200).setLatestArrival(36060).setType(type).build();
    VehicleImpl v3 =
        VehicleImpl.Builder.newInstance("vehicle3").setStartLocation(Location.newInstance(0))
            .setEarliestStart(36000).setLatestArrival(54060).setType(type).build();
    VehicleImpl v4 =
        VehicleImpl.Builder.newInstance("vehicle4").setStartLocation(Location.newInstance(0))
            .setEarliestStart(36000).setLatestArrival(54060).setType(type).build();

    Service s1 = Service.Builder.newInstance("1")
        .setLocation(Location.Builder.newInstance().setIndex(1).setId("js0").build())
        .setServiceTime(600).setTimeWindow(TimeWindow.newInstance(0, 1800)).addSizeDimension(0, 1)
        .build();
    Service s2 = Service.Builder.newInstance("2")
        .setLocation(Location.Builder.newInstance().setIndex(2).setId("js2").build())
        .setServiceTime(600).setTimeWindow(TimeWindow.newInstance(5400, 7200))
        .addSizeDimension(0, 2).build();
    Service s3 = Service.Builder.newInstance("3")
        .setLocation(Location.Builder.newInstance().setIndex(3).setId("js5").build())
        .setServiceTime(1800).setTimeWindow(TimeWindow.newInstance(17100, 18000))
        .addSizeDimension(0, 10).build();
    Service s4 = Service.Builder.newInstance("4")
        .setLocation(Location.Builder.newInstance().setIndex(4).setId("js4").build())
        .setServiceTime(900).addSizeDimension(0, 2).build();
    Service s5 = Service.Builder.newInstance("5")
        .setLocation(Location.Builder.newInstance().setIndex(5).setId("js8").build())
        .setServiceTime(600).addSizeDimension(0, 4).build();
    Service s6 = Service.Builder.newInstance("6")
        .setLocation(Location.Builder.newInstance().setIndex(6).setId("js10").build())
        .setServiceTime(1500).setTimeWindow(TimeWindow.newInstance(29700, 32400))
        .addSizeDimension(0, 10).build();
    Service s7 = Service.Builder.newInstance("7")
        .setLocation(Location.Builder.newInstance().setIndex(7).setId("jsp3").build())
        .setServiceTime(5594).build();

    Shipment shipment1 = Shipment.Builder.newInstance("shipment1").setPickupServiceTime(900)
    ...
    Shipment shipment2 = Shipment.Builder.newInstance("shipment2")
        ...
        .setPickupServiceTime(1200).addPickupTimeWindow(21600, 23400)
        .setDeliveryLocation(Location.Builder.newInstance().setId("jsd4").setIndex(8).build())
        .setDeliveryServiceTime(900).addDeliveryTimeWindow(25200, 27000).build();
    ...
    Shipment shipment3 = Shipment.Builder.newInstance("shipment3")
        ...
        .setPickupServiceTime(1200).addPickupTimeWindow(37800, 41400)
        .setDeliveryLocation(Location.Builder.newInstance().setId("jsd7").setIndex(8).build())
        .setDeliveryServiceTime(1800).addDeliveryTimeWindow(43200, 45900).build();
    ...
    Shipment shipment4 = Shipment.Builder.newInstance("shipment4")
        ...
        .setPickupServiceTime(300).addPickupTimeWindow(45000, 48600)
        .setDeliveryLocation(Location.Builder.newInstance().setId("jsd9").setIndex(8).build())
        .setDeliveryServiceTime(300).addDeliveryTimeWindow(50400, 52200).build();

    FastVehicleRoutingTransportCostsMatrix matrix = createMatrix();
    return VehicleRoutingProblem.Builder.newInstance()
        .setFleetSize(VehicleRoutingProblem.FleetSize.FINITE).addJob(s1).addJob(s2).addJob(s3)
        .addJob(s4).addJob(s5).addJob(s6).addJob(s7).addJob(shipment1).addJob(shipment2)
        .addJob(shipment3).addJob(shipment4).addVehicle(v0).addVehicle(v1).addVehicle(v2)
        .addVehicle(v3).addVehicle(v4).setRoutingCost(matrix).build();
