...
public class ShipmentInsertionCalculatorFlexTest {
  ...
  public void whenInstertingShipmentWithLoadConstraintWhereCapIsNotSufficient_capConstraintsAreFulfilled() {
    ...
    ShipmentInsertionCalculatorFlex insertionCalculator = new ShipmentInsertionCalculatorFlex(
        routingCosts, activityCosts, activityInsertionCostsCalculator, constraintManager);
