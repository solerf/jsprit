...
public class VehicleRoutingAlgorithmTest {
  ...
  public void whenSettingIterations_itIsSetCorrectly() {
    VehicleRoutingAlgorithm algorithm = new VehicleRoutingAlgorithm(
        mock(VehicleRoutingProblem.class), mock(SearchStrategyManager.class));
  ...
  public void whenSettingIterationsWithMaxIterations_iterAreExecutedCorrectly() {
    ...
    VehicleRoutingAlgorithm algorithm =
        new VehicleRoutingAlgorithm(mock(VehicleRoutingProblem.class), stratManager);
