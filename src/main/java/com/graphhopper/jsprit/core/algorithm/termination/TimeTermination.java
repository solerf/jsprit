 ...
 * <p>
 * <p>
 * Note, TimeTermination must be registered as AlgorithmListener <br>
...
public class TimeTermination implements PrematureAlgorithmTermination, AlgorithmStartsListener {
   ...
   *
   * @param timeThreshold_in_milliseconds the computation time [in ms] after which the algorithm
   *        terminates
   */
