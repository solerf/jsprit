...
abstract class AbstractInsertionCalculator implements JobInsertionCostsCalculator {
  ...
  InsertionData checkRouteContraints(JobInsertionContext insertionContext,
  ...
  ConstraintsStatus fulfilled(JobInsertionContext iFacts, TourActivity prevAct, TourActivity newAct,
      ...
      Collection<HardConstraint> failedActivityConstraints, ConstraintManager constraintManager) {
    ...
    for (HardActivityConstraint constraint : constraintManager
      ...
      if (status.equals(ConstraintsStatus.NOT_FULFILLED_BREAK)
          || status.equals(ConstraintsStatus.NOT_FULFILLED)) {
