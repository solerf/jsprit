...
class JobCalculatorSwitcher implements JobInsertionCostsCalculator {
  ...
  private final Map<Class<? extends Job>, JobInsertionCostsCalculator> calcMap =
      new HashMap<Class<? extends Job>, JobInsertionCostsCalculator>();
  ...
  public InsertionData getInsertionData(VehicleRoute currentRoute, Job jobToInsert,
    ...
    if (jic == null)
      throw new IllegalStateException("cannot find calculator for " + jobToInsert.getClass());
    return jic.getInsertionData(currentRoute, jobToInsert, newVehicle, newVehicleDepartureTime,
        newDriver, bestKnownScore);
  }
