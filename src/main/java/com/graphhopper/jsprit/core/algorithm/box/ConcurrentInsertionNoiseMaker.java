...
class ConcurrentInsertionNoiseMaker
    implements SoftActivityConstraint, IterationStartsListener, ActivityNoiseMaker {
  ...
  ConcurrentInsertionNoiseMaker(VehicleRoutingProblem vrp, double maxCosts, double noiseLevel,
