...
public final class RuinClusters extends AbstractRuinStrategy implements IterationStartsListener {
  ...
  public static class JobActivityWrapper implements Clusterable {
    ...
    public double[] getPoint() {
      return new double[] {jobActivity.getLocation().getCoordinate().getX(),
          jobActivity.getLocation().getCoordinate().getY()};
    }
  ...
  public RuinClusters(VehicleRoutingProblem vrp, final int initialNumberJobsToRemove,
