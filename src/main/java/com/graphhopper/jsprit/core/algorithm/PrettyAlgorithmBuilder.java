...
public class PrettyAlgorithmBuilder {
  ...
  public static PrettyAlgorithmBuilder newInstance(VehicleRoutingProblem vrp,
  ...
  PrettyAlgorithmBuilder(VehicleRoutingProblem vrp, VehicleFleetManager fleetManager,
  ...
  public PrettyAlgorithmBuilder constructInitialSolutionWith(InsertionStrategy insertionStrategy,
  ...
  public VehicleRoutingAlgorithm build() {
    ...
    VehicleRoutingAlgorithm vra =
        new VehicleRoutingAlgorithm(vrp, searchStrategyManager, objectiveFunction);
    ...
    if (iniInsertionStrategy != null) {
      ...
      vra.addListener((AlgorithmStartsListener) (problem, algorithm, solutions) -> {
        if (solutions.isEmpty()) {
          solutions.add(new InsertionInitialSolutionFactory(iniInsertionStrategy, iniObjFunction)
              .createSolution(vrp));
        }
      });
    }
