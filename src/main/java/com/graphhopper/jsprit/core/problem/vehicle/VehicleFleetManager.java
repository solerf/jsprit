...
public interface VehicleFleetManager {
   ...
   * <p>
   * <p>
   * This indicates that this vehicle is not being used anymore. Thus it is in list of available
   * vehicles.
   *
   ...
   * <p>
   * <p>
   * Note that this does not return ALL available vehicles that were added to the fleetmanager.
   * Vehicles are clustered according to {@link VehicleTypeKey}. If there are two unlocked vehicle
   * with the same VehicleTypeKey then only one of them will be returned. This is to avoid returning
   * too many vehicles that are basically equal.
   * <p>
