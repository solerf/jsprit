 ...
 * <p>
 * <p>
 * Transport here is what happens between two activities within the transport system, i.e. in the
 * physical transport network. And must give the answer of how long does it take from A to B, and
...
public interface VehicleRoutingTransportCosts
    extends TransportTime, TransportCost, TransportDistance {
