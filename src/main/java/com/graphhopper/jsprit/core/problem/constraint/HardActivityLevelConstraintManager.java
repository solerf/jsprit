...
class HardActivityLevelConstraintManager implements HardActivityConstraint {
  ...
  private final Collection<HardActivityConstraint> criticalConstraints =
      new ArrayList<HardActivityConstraint>();

  private final Collection<HardActivityConstraint> highPrioConstraints =
      new ArrayList<HardActivityConstraint>();

  private final Collection<HardActivityConstraint> lowPrioConstraints =
      new ArrayList<HardActivityConstraint>();

  public void addConstraint(HardActivityConstraint constraint,
