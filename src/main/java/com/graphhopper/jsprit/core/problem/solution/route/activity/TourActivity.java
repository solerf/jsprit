 ...
 * <p>
 * <p>
 * A tour activity is the basic element of a tour, which is consequently a sequence of
 * tour-activities.
 *
 * @author schroeder
 */
public interface TourActivity extends HasIndex {
   ...
   * <code>service.getTimeWindow().getStart()</code>.
   *
   ...
   * <code>service.getTimeWindow().getEnd()</code>.
   *
   ...
   * <p>
   * <p>
   * Note that this is not necessarily the duration of this activity, but the service time a
   * pickup/delivery actually takes, that is for example <code>service.getServiceTime()</code>.
   *
  ...
  /**
   * Returns the capacity-demand of that activity, in terms of what needs to be loaded or unloaded
   * at this activity.
   *
   * @return capacity
   */
