...
public class JobInsertionContext {
  ...
  /**
   * Returns the vehicle that should operate the new route, i.e. route <code>this.getRoute()</code>
   * + new job <code>this.getJob()</code>.
   *
  ...
  /**
   * Returns the driver that should operate the new route, i.e. route <code>this.getRoute()</code> +
   * new job <code>this.getJob()</code>.
   * <p>
   * <p>
   ...
   */
  public JobInsertionContext(VehicleRoute route, Job job, Vehicle newVehicle, Driver newDriver,
      double newDepTime) {
    super();
    this.route = route;
    this.job = job;
