...
public class FastVehicleRoutingTransportCostsMatrix
  ...
  public static class Builder {
    ...
    public Builder addTransportTimeAndDistance(int fromIndex, int toIndex, double time,
        double distance) {
  ...
  /**
   * First dim is from, second to and third indicates whether it is a distance value (index=0) or
   * time value (index=1).
   *
   * @return
   */
  ...
  public double getTransportCost(Location from, Location to, double departureTime, Driver driver,
    ...
    return costParams.perDistanceUnit * getDistance(from.getIndex(), to.getIndex())
        + costParams.perTransportTimeUnit
