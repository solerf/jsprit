...
public class SolutionPrinter {
  ...
  public static void print(PrintWriter out, VehicleRoutingProblem problem,
      VehicleRoutingProblemSolution solution, Print print) {
  ...
  private static void printVerbose(VehicleRoutingProblem problem,
  ...
  private static void printVerbose(PrintWriter out, VehicleRoutingProblem problem,
    ...
    for (VehicleRoute route : list) {
      ...
      out.format(leftAlgin, routeNu, getVehicleString(route), route.getStart().getName(), "-",
          "undef", Math.round(route.getStart().getEndTime()), Math.round(costs));
      ...
      for (TourActivity act : route.getActivities()) {
        ...
        double c = problem.getTransportCosts().getTransportCost(prevAct.getLocation(),
        ...
        out.format(leftAlgin, routeNu, getVehicleString(route), act.getName(), jobId,
            Math.round(act.getArrTime()), Math.round(act.getEndTime()), Math.round(costs));
        prevAct = act;
      }
      double c = problem.getTransportCosts().getTransportCost(prevAct.getLocation(),
      ...
      out.format(leftAlgin, routeNu, getVehicleString(route), route.getEnd().getName(), "-",
          Math.round(route.getEnd().getArrTime()), "undef", Math.round(costs));
      routeNu++;
    }
    out.format(
        "+--------------------------------------------------------------------------------------------------------------------------------+%n");
